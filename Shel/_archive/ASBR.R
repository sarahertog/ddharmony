...
## Description: Calculation of 5-year age specific birth rates
...
## 7. Merge the population data with the births data.----------------------------------------------------------- 
merged_df <- pop5_df2 %>% 
...
## 8. Calculate the age specific birth rates for each of the years and age labels.-------------------------------
merged_df <- merged_df %>% 
  mutate(asbr = births.count / pop.count)

## 9. Reshape the data so that we have category on one variable (pop.count, births.count, asbr).-------------------------------
...
## 10. Extract each of the datasets i.e pop_df, births_df, asbr_df.-------------------------------